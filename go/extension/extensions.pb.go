...
type GetOffloadedAppsStatisticsResponse_DHCPv4RAStats struct {
	Stat                 map[string]string `protobuf:"bytes,1,rep,name=stat,proto3" json:"stat,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *GetOffloadedAppsStatisticsResponse_DHCPv4RAStats) GetStat() map[string]string {
	if m != nil {
		return m.Stat
	}
	return nil
...
func (m *GetOffloadedAppsStatisticsResponse_DHCPv6RAStats) GetStat() map[string]string {
	if m != nil {
		return m.Stat
	}
	return nil
...
func (m *GetOffloadedAppsStatisticsResponse_PPPoeIAStats) GetStat() map[string]string {
	if m != nil {
		return m.Stat
	}
	return nil
...
type AppOffloadConfig struct {
	...
	// Follows the same as the BBF Access Node Id defined in https://www.netconfcentral.org/modules/bbf-subscriber-profiles/2020-10-13?path=/sys:system?container/bbf-subprof:subscriber-management
...
type AppOffloadOnuConfig_PerUniConfig struct {
	// As per the BBF Agent Remote Id defined in https://www.netconfcentral.org/modules/bbf-pppoe-intermediate-agent/2022-03-01/source/raw/
	AgentRemoteID string `protobuf:"bytes,2,opt,name=agentRemoteID,proto3" json:"agentRemoteID,omitempty"`
	// As per the BBF Agent Circuit Id defined in https://www.netconfcentral.org/modules/bbf-pppoe-intermediate-agent/2022-03-01/source/raw/
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "extension.GetOffloadedAppsStatisticsResponse.DHCPv4RAStats.StatEntry")
	...
	proto.RegisterMapType((map[string]string)(nil), "extension.GetOffloadedAppsStatisticsResponse.DHCPv6RAStats.StatEntry")
	...
	proto.RegisterMapType((map[string]string)(nil), "extension.GetOffloadedAppsStatisticsResponse.PPPoeIAStats.StatEntry")
...
var fileDescriptor_7ecf6e9799a9202d = []byte{
	...
	,
}
