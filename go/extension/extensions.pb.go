...
const file_voltha_protos_extensions_proto_rawDesc = "" +
	...
	"\x05empty\x18\x01 \x01(\v2\x16.google.protobuf.EmptyR\x05empty\"\xaf\x02\n" +
	...
	"\x11receivedGEMFrames\x18\x03 \x01(\rR\x11receivedGEMFrames\x122\n" +
	"\x14receivedPayloadBytes\x18\x04 \x01(\rR\x14receivedPayloadBytes\x128\n" +
	"\x17transmittedPayloadBytes\x18\x05 \x01(\rR\x17transmittedPayloadBytes\x120\n" +
	"\x13encryptionKeyErrors\x18\x06 \x01(\rR\x13encryptionKeyErrors\"I\n" +
	...
	"\x05empty\x18\x01 \x01(\v2\x16.google.protobuf.EmptyR\x05empty\"\xf2\x01\n" +
	"\x18GetOnuFecHistoryResponse\x12&\n" +
	"\x0ecorrectedBytes\x18\x01 \x01(\rR\x0ecorrectedBytes\x12.\n" +
	"\x12correctedCodeWords\x18\x02 \x01(\rR\x12correctedCodeWords\x12\x1e\n" +
	"\n" +
	"fecSeconds\x18\x03 \x01(\rR\n" +
	"fecSeconds\x12&\n" +
	"\x0etotalCodeWords\x18\x04 \x01(\rR\x0etotalCodeWords\x126\n" +
	"\x16uncorrectableCodeWords\x18\x05 \x01(\rR\x16uncorrectableCodeWords\"G\n" +
	...
	"\x11allocGemStatsInfo\x18\x01 \x03(\v2*.extension.OnuAllocGemStatsFromOltResponseR\x11allocGemStatsInfo\"\xe4\f\n" +
	...
	"\ttimestamp\x18\x1b \x01(\aH\x1aR\ttimestampB\f\n" +
	"\n" +
	"is_intf_idB\v\n" +
	"\tis_onu_idB\x13\n" +
