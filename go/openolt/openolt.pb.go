...
//
// Onu object structure, contians the state of the onu id, state, and alarms.
...
type OnuObjectData struct {
	...
	Losi                 AlarmState `protobuf:"varint,2,opt,name=losi,proto3,enum=openolt.AlarmState" json:"losi,omitempty"`
	Lofi                 AlarmState `protobuf:"varint,3,opt,name=lofi,proto3,enum=openolt.AlarmState" json:"lofi,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
//
// IntfObjectData would have the intfid and the state of the interfaces.
...
type ObjectDataResponse struct {
	// Types that are valid to be assigned to Data:
	//	*ObjectDataResponse_OnuObjectDta
...
type ObjectDataResponse_OnuObjectDta struct {
	OnuObjectDta *OnuObjectData `protobuf:"bytes,2,opt,name=onu_object_dta,json=onuObjectDta,proto3,oneof"`
}
...
func (*ObjectDataResponse_OnuObjectDta) isObjectDataResponse_Data() {}
...
func (m *ObjectDataResponse) GetOnuObjectDta() *OnuObjectData {
	if x, ok := m.GetData().(*ObjectDataResponse_OnuObjectDta); ok {
		return x.OnuObjectDta
	}
	return nil
}
...
func (*ObjectDataResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ObjectDataResponse_OnuObjectDta)(nil),
...
var fileDescriptor_c072e7aa0dfd74d5 = []byte{
	...
	,
}
