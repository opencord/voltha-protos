...
func (OnuInfo_OnuState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{56, 0}
}
...
func (PonIntfInfo_PonIntfState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{57, 0}
}
...
type NniStatsData struct {
	NniPort              uint32   `protobuf:"fixed32,1,opt,name=nniPort,proto3" json:"nniPort,omitempty"`
	RxBytes              uint32   `protobuf:"fixed32,2,opt,name=rxBytes,proto3" json:"rxBytes,omitempty"`
	RxPackets            uint32   `protobuf:"fixed32,3,opt,name=rxPackets,proto3" json:"rxPackets,omitempty"`
	RxUcastPackets       uint32   `protobuf:"fixed32,4,opt,name=rxUcastPackets,proto3" json:"rxUcastPackets,omitempty"`
	RxMcastPackets       uint32   `protobuf:"fixed32,5,opt,name=rxMcastPackets,proto3" json:"rxMcastPackets,omitempty"`
	RxBcastPackets       uint32   `protobuf:"fixed32,6,opt,name=rxBcastPackets,proto3" json:"rxBcastPackets,omitempty"`
	RxErrorPackets       uint32   `protobuf:"fixed32,7,opt,name=rxErrorPackets,proto3" json:"rxErrorPackets,omitempty"`
	RxFcsErrorPackets    uint32   `protobuf:"fixed32,8,opt,name=rxFcsErrorPackets,proto3" json:"rxFcsErrorPackets,omitempty"`
	RxUndersizePackets   uint32   `protobuf:"fixed32,9,opt,name=rxUndersizePackets,proto3" json:"rxUndersizePackets,omitempty"`
	RxOversizePackets    uint32   `protobuf:"fixed32,10,opt,name=rxOversizePackets,proto3" json:"rxOversizePackets,omitempty"`
	TxBytes              uint32   `protobuf:"fixed32,11,opt,name=txBytes,proto3" json:"txBytes,omitempty"`
	TxPackets            uint32   `protobuf:"fixed32,12,opt,name=txPackets,proto3" json:"txPackets,omitempty"`
	TxUcastPackets       uint32   `protobuf:"fixed32,13,opt,name=txUcastPackets,proto3" json:"txUcastPackets,omitempty"`
	TxMcastPackets       uint32   `protobuf:"fixed32,14,opt,name=txMcastPackets,proto3" json:"txMcastPackets,omitempty"`
	TxBcastPackets       uint32   `protobuf:"fixed32,15,opt,name=txBcastPackets,proto3" json:"txBcastPackets,omitempty"`
	TxErrorPackets       uint32   `protobuf:"fixed32,16,opt,name=txErrorPackets,proto3" json:"txErrorPackets,omitempty"`
	TxUndersizePackets   uint32   `protobuf:"fixed32,17,opt,name=txUndersizePackets,proto3" json:"txUndersizePackets,omitempty"`
	TxOversizePackets    uint32   `protobuf:"fixed32,18,opt,name=txOversizePackets,proto3" json:"txOversizePackets,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *NniStatsData) Reset()         { *m = NniStatsData{} }
func (m *NniStatsData) String() string { return proto.CompactTextString(m) }
func (*NniStatsData) ProtoMessage()    {}
func (*NniStatsData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{50}
}

func (m *NniStatsData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_NniStatsData.Unmarshal(m, b)
}
func (m *NniStatsData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_NniStatsData.Marshal(b, m, deterministic)
}
func (m *NniStatsData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NniStatsData.Merge(m, src)
}
func (m *NniStatsData) XXX_Size() int {
	return xxx_messageInfo_NniStatsData.Size(m)
}
func (m *NniStatsData) XXX_DiscardUnknown() {
	xxx_messageInfo_NniStatsData.DiscardUnknown(m)
}

var xxx_messageInfo_NniStatsData proto.InternalMessageInfo

func (m *NniStatsData) GetNniPort() uint32 {
	if m != nil {
		return m.NniPort
	}
	return 0
...
func (m *NniStatsData) GetRxBytes() uint32 {
	if m != nil {
		return m.RxBytes
	}
	return 0
...
func (m *NniStatsData) GetRxPackets() uint32 {
	if m != nil {
		return m.RxPackets
	}
	return 0
...
func (m *NniStatsData) GetRxUcastPackets() uint32 {
	if m != nil {
		return m.RxUcastPackets
	}
	return 0
...
func (m *NniStatsData) GetRxMcastPackets() uint32 {
	if m != nil {
		return m.RxMcastPackets
	}
	return 0
...
func (m *NniStatsData) GetRxBcastPackets() uint32 {
	if m != nil {
		return m.RxBcastPackets
	}
	return 0
...
func (m *NniStatsData) GetRxErrorPackets() uint32 {
	if m != nil {
		return m.RxErrorPackets
	}
	return 0
...
func (m *NniStatsData) GetRxFcsErrorPackets() uint32 {
	if m != nil {
...
func (m *NniStatsData) GetRxUndersizePackets() uint32 {
	if m != nil {
...
func (m *NniStatsData) GetRxOversizePackets() uint32 {
	if m != nil {
...
func (m *NniStatsData) GetTxBytes() uint32 {
	if m != nil {
		return m.TxBytes
	}
	return 0
...
func (m *NniStatsData) GetTxPackets() uint32 {
	if m != nil {
		return m.TxPackets
	}
	return 0
...
func (m *NniStatsData) GetTxUcastPackets() uint32 {
	if m != nil {
		return m.TxUcastPackets
	}
	return 0
...
func (m *NniStatsData) GetTxMcastPackets() uint32 {
	if m != nil {
		return m.TxMcastPackets
	}
	return 0
...
func (m *NniStatsData) GetTxBcastPackets() uint32 {
	if m != nil {
		return m.TxBcastPackets
	}
	return 0
...
func (m *NniStatsData) GetTxErrorPackets() uint32 {
	if m != nil {
		return m.TxErrorPackets
	}
	return 0
...
func (m *NniStatsData) GetTxUndersizePackets() uint32 {
	if m != nil {
...
func (m *NniStatsData) GetTxOversizePackets() uint32 {
	if m != nil {
...
type PonStatsData struct {
	IntfId                  uint32   `protobuf:"fixed32,1,opt,name=intfId,proto3" json:"intfId,omitempty"`
	BipUnits                uint32   `protobuf:"fixed32,2,opt,name=bipUnits,proto3" json:"bipUnits,omitempty"`
	BipErrors               uint32   `protobuf:"fixed32,3,opt,name=bipErrors,proto3" json:"bipErrors,omitempty"`
	RxPackets               uint32   `protobuf:"fixed32,4,opt,name=rxPackets,proto3" json:"rxPackets,omitempty"`
	RxGem                   uint32   `protobuf:"fixed32,5,opt,name=rxGem,proto3" json:"rxGem,omitempty"`
	RxGemDropped            uint32   `protobuf:"fixed32,6,opt,name=rxGemDropped,proto3" json:"rxGemDropped,omitempty"`
	RxGemIdle               uint32   `protobuf:"fixed32,7,opt,name=rxGemIdle,proto3" json:"rxGemIdle,omitempty"`
	RxGemCorrected          uint32   `protobuf:"fixed32,8,opt,name=rxGemCorrected,proto3" json:"rxGemCorrected,omitempty"`
	RxGemIllegal            uint32   `protobuf:"fixed32,9,opt,name=rxGemIllegal,proto3" json:"rxGemIllegal,omitempty"`
	RxCrcError              uint32   `protobuf:"fixed32,10,opt,name=rxCrcError,proto3" json:"rxCrcError,omitempty"`
	RxFragmentError         uint32   `protobuf:"fixed32,11,opt,name=rxFragmentError,proto3" json:"rxFragmentError,omitempty"`
	RxPacketsDropped        uint32   `protobuf:"fixed32,12,opt,name=rxPacketsDropped,proto3" json:"rxPacketsDropped,omitempty"`
	RxCpuOmciPacketsDropped uint32   `protobuf:"fixed32,13,opt,name=rxCpuOmciPacketsDropped,proto3" json:"rxCpuOmciPacketsDropped,omitempty"`
	RxCpu                   uint32   `protobuf:"fixed32,14,opt,name=rxCpu,proto3" json:"rxCpu,omitempty"`
	RxOmci                  uint32   `protobuf:"fixed32,15,opt,name=rxOmci,proto3" json:"rxOmci,omitempty"`
	RxOmciPacketsCrcError   uint32   `protobuf:"fixed32,16,opt,name=rxOmciPacketsCrcError,proto3" json:"rxOmciPacketsCrcError,omitempty"`
	TxPackets               uint32   `protobuf:"fixed32,17,opt,name=txPackets,proto3" json:"txPackets,omitempty"`
	TxGem                   uint32   `protobuf:"fixed32,18,opt,name=txGem,proto3" json:"txGem,omitempty"`
	TxCpu                   uint32   `protobuf:"fixed32,19,opt,name=txCpu,proto3" json:"txCpu,omitempty"`
	TxOmci                  uint32   `protobuf:"fixed32,20,opt,name=txOmci,proto3" json:"txOmci,omitempty"`
	TxDroppedIllegalLength  uint32   `protobuf:"fixed32,21,opt,name=txDroppedIllegalLength,proto3" json:"txDroppedIllegalLength,omitempty"`
	TxDroppedTpidMiss       uint32   `protobuf:"fixed32,22,opt,name=txDroppedTpidMiss,proto3" json:"txDroppedTpidMiss,omitempty"`
	TxDroppedVidMiss        uint32   `protobuf:"fixed32,23,opt,name=txDroppedVidMiss,proto3" json:"txDroppedVidMiss,omitempty"`
	TxDroppedTotal          uint32   `protobuf:"fixed32,24,opt,name=txDroppedTotal,proto3" json:"txDroppedTotal,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}

func (m *PonStatsData) Reset()         { *m = PonStatsData{} }
func (m *PonStatsData) String() string { return proto.CompactTextString(m) }
func (*PonStatsData) ProtoMessage()    {}
func (*PonStatsData) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{51}
}

func (m *PonStatsData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PonStatsData.Unmarshal(m, b)
}
func (m *PonStatsData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PonStatsData.Marshal(b, m, deterministic)
}
func (m *PonStatsData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PonStatsData.Merge(m, src)
}
func (m *PonStatsData) XXX_Size() int {
	return xxx_messageInfo_PonStatsData.Size(m)
}
func (m *PonStatsData) XXX_DiscardUnknown() {
	xxx_messageInfo_PonStatsData.DiscardUnknown(m)
}

var xxx_messageInfo_PonStatsData proto.InternalMessageInfo

func (m *PonStatsData) GetIntfId() uint32 {
	if m != nil {
		return m.IntfId
	}
	return 0
...
func (m *PonStatsData) GetBipUnits() uint32 {
	if m != nil {
		return m.BipUnits
	}
	return 0
...
func (m *PonStatsData) GetBipErrors() uint32 {
	if m != nil {
		return m.BipErrors
	}
	return 0
...
func (m *PonStatsData) GetRxPackets() uint32 {
	if m != nil {
		return m.RxPackets
	}
	return 0
...
func (m *PonStatsData) GetRxGem() uint32 {
	if m != nil {
		return m.RxGem
	}
	return 0
...
func (m *PonStatsData) GetRxGemDropped() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetRxGemIdle() uint32 {
	if m != nil {
		return m.RxGemIdle
	}
	return 0
...
func (m *PonStatsData) GetRxGemCorrected() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetRxGemIllegal() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetRxCrcError() uint32 {
	if m != nil {
		return m.RxCrcError
	}
	return 0
...
func (m *PonStatsData) GetRxFragmentError() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetRxPacketsDropped() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetRxCpuOmciPacketsDropped() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetRxCpu() uint32 {
	if m != nil {
		return m.RxCpu
	}
	return 0
...
func (m *PonStatsData) GetRxOmci() uint32 {
	if m != nil {
		return m.RxOmci
	}
	return 0
...
func (m *PonStatsData) GetRxOmciPacketsCrcError() uint32 {
	if m != nil {
		return m.RxOmciPacketsCrcError
	}
	return 0
...
func (m *PonStatsData) GetTxPackets() uint32 {
	if m != nil {
		return m.TxPackets
	}
	return 0
...
func (m *PonStatsData) GetTxGem() uint32 {
	if m != nil {
		return m.TxGem
	}
	return 0
...
func (m *PonStatsData) GetTxCpu() uint32 {
	if m != nil {
		return m.TxCpu
	}
	return 0
...
func (m *PonStatsData) GetTxOmci() uint32 {
	if m != nil {
		return m.TxOmci
	}
	return 0
...
func (m *PonStatsData) GetTxDroppedIllegalLength() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetTxDroppedTpidMiss() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetTxDroppedVidMiss() uint32 {
	if m != nil {
...
func (m *PonStatsData) GetTxDroppedTotal() uint32 {
	if m != nil {
...
type OnuGemPortInfo struct {
	GemId                uint32   `protobuf:"fixed32,1,opt,name=gemId,proto3" json:"gemId,omitempty"`
	RxPackets            uint32   `protobuf:"fixed32,2,opt,name=rxPackets,proto3" json:"rxPackets,omitempty"`
	RxBytes              uint32   `protobuf:"fixed32,3,opt,name=rxBytes,proto3" json:"rxBytes,omitempty"`
	TxPackets            uint32   `protobuf:"fixed32,4,opt,name=txPackets,proto3" json:"txPackets,omitempty"`
	TxBytes              uint32   `protobuf:"fixed32,5,opt,name=txBytes,proto3" json:"txBytes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *OnuGemPortInfo) Reset()         { *m = OnuGemPortInfo{} }
func (m *OnuGemPortInfo) String() string { return proto.CompactTextString(m) }
func (*OnuGemPortInfo) ProtoMessage()    {}
func (*OnuGemPortInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{52}
}

func (m *OnuGemPortInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OnuGemPortInfo.Unmarshal(m, b)
}
func (m *OnuGemPortInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OnuGemPortInfo.Marshal(b, m, deterministic)
}
func (m *OnuGemPortInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OnuGemPortInfo.Merge(m, src)
}
func (m *OnuGemPortInfo) XXX_Size() int {
	return xxx_messageInfo_OnuGemPortInfo.Size(m)
}
func (m *OnuGemPortInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_OnuGemPortInfo.DiscardUnknown(m)
}

var xxx_messageInfo_OnuGemPortInfo proto.InternalMessageInfo

func (m *OnuGemPortInfo) GetGemId() uint32 {
	if m != nil {
		return m.GemId
	}
	return 0
...
func (m *OnuGemPortInfo) GetRxPackets() uint32 {
	if m != nil {
		return m.RxPackets
	}
	return 0
...
func (m *OnuGemPortInfo) GetRxBytes() uint32 {
	if m != nil {
		return m.RxBytes
	}
	return 0
...
func (m *OnuGemPortInfo) GetTxPackets() uint32 {
	if m != nil {
		return m.TxPackets
	}
	return 0
...
func (m *OnuGemPortInfo) GetTxBytes() uint32 {
	if m != nil {
		return m.TxBytes
	}
	return 0
...
type OnuAllocIdInfo struct {
	AllocId              uint32   `protobuf:"fixed32,1,opt,name=allocId,proto3" json:"allocId,omitempty"`
	RxBytes              uint32   `protobuf:"fixed32,2,opt,name=rxBytes,proto3" json:"rxBytes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *OnuAllocIdInfo) Reset()         { *m = OnuAllocIdInfo{} }
func (m *OnuAllocIdInfo) String() string { return proto.CompactTextString(m) }
func (*OnuAllocIdInfo) ProtoMessage()    {}
func (*OnuAllocIdInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{53}
}

func (m *OnuAllocIdInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OnuAllocIdInfo.Unmarshal(m, b)
}
func (m *OnuAllocIdInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OnuAllocIdInfo.Marshal(b, m, deterministic)
}
func (m *OnuAllocIdInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OnuAllocIdInfo.Merge(m, src)
}
func (m *OnuAllocIdInfo) XXX_Size() int {
	return xxx_messageInfo_OnuAllocIdInfo.Size(m)
}
func (m *OnuAllocIdInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_OnuAllocIdInfo.DiscardUnknown(m)
}

var xxx_messageInfo_OnuAllocIdInfo proto.InternalMessageInfo

func (m *OnuAllocIdInfo) GetAllocId() uint32 {
	if m != nil {
		return m.AllocId
	}
	return 0
...
func (m *OnuAllocIdInfo) GetRxBytes() uint32 {
	if m != nil {
		return m.RxBytes
	}
	return 0
...
type OnuAllocGemStatsResponse struct {
	AllocIdInfo          *OnuAllocIdInfo   `protobuf:"bytes,1,opt,name=allocIdInfo,proto3" json:"allocIdInfo,omitempty"`
	GemPortInfo          []*OnuGemPortInfo `protobuf:"bytes,2,rep,name=gemPortInfo,proto3" json:"gemPortInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}

func (m *OnuAllocGemStatsResponse) Reset()         { *m = OnuAllocGemStatsResponse{} }
func (m *OnuAllocGemStatsResponse) String() string { return proto.CompactTextString(m) }
func (*OnuAllocGemStatsResponse) ProtoMessage()    {}
func (*OnuAllocGemStatsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{54}
}

func (m *OnuAllocGemStatsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OnuAllocGemStatsResponse.Unmarshal(m, b)
}
func (m *OnuAllocGemStatsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OnuAllocGemStatsResponse.Marshal(b, m, deterministic)
}
func (m *OnuAllocGemStatsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OnuAllocGemStatsResponse.Merge(m, src)
}
func (m *OnuAllocGemStatsResponse) XXX_Size() int {
	return xxx_messageInfo_OnuAllocGemStatsResponse.Size(m)
}
func (m *OnuAllocGemStatsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_OnuAllocGemStatsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_OnuAllocGemStatsResponse proto.InternalMessageInfo

func (m *OnuAllocGemStatsResponse) GetAllocIdInfo() *OnuAllocIdInfo {
	if m != nil {
...
func (m *OnuAllocGemStatsResponse) GetGemPortInfo() []*OnuGemPortInfo {
	if m != nil {
...
type OnuStatsResponse struct {
	OnuStatsInfo         []*OnuAllocGemStatsResponse `protobuf:"bytes,1,rep,name=onuStatsInfo,proto3" json:"onuStatsInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}

func (m *OnuStatsResponse) Reset()         { *m = OnuStatsResponse{} }
func (m *OnuStatsResponse) String() string { return proto.CompactTextString(m) }
func (*OnuStatsResponse) ProtoMessage()    {}
func (*OnuStatsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{55}
}

func (m *OnuStatsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_OnuStatsResponse.Unmarshal(m, b)
}
func (m *OnuStatsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_OnuStatsResponse.Marshal(b, m, deterministic)
}
func (m *OnuStatsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OnuStatsResponse.Merge(m, src)
}
func (m *OnuStatsResponse) XXX_Size() int {
	return xxx_messageInfo_OnuStatsResponse.Size(m)
}
func (m *OnuStatsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_OnuStatsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_OnuStatsResponse proto.InternalMessageInfo

func (m *OnuStatsResponse) GetOnuStatsInfo() []*OnuAllocGemStatsResponse {
	if m != nil {
		return m.OnuStatsInfo
	}
	return nil
}
...
func (*PonIntfInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{57}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_c072e7aa0dfd74d5, []int{58}
}
...
func init() {
	...
	proto.RegisterType((*NniStatsData)(nil), "openolt.NniStatsData")
	proto.RegisterType((*PonStatsData)(nil), "openolt.PonStatsData")
	proto.RegisterType((*OnuGemPortInfo)(nil), "openolt.OnuGemPortInfo")
	proto.RegisterType((*OnuAllocIdInfo)(nil), "openolt.OnuAllocIdInfo")
	proto.RegisterType((*OnuAllocGemStatsResponse)(nil), "openolt.OnuAllocGemStatsResponse")
	proto.RegisterType((*OnuStatsResponse)(nil), "openolt.OnuStatsResponse")
...
var fileDescriptor_c072e7aa0dfd74d5 = []byte{
	...
	,
}
...
type OpenoltClient interface {
	...
	//
	// GetOnuAllocGemStatistics takes Onu id, intf_id and serial number as argument from Onu structure.
	// Returns Alloc and Gem stats for the Onu in the form of OnuStatsResponse structure
	GetOnuAllocGemStatistics(ctx context.Context, in *Onu, opts ...grpc.CallOption) (*OnuStatsResponse, error)
	//
	...
	GetPonPortStatistics(ctx context.Context, in *Interface, opts ...grpc.CallOption) (*PonStatsData, error)
	//
	...
	GetNniPortStatistics(ctx context.Context, in *Onu, opts ...grpc.CallOption) (*NniStatsData, error)
}
...
func (c *openoltClient) GetOnuAllocGemStatistics(ctx context.Context, in *Onu, opts ...grpc.CallOption) (*OnuStatsResponse, error) {
	out := new(OnuStatsResponse)
	err := c.cc.Invoke(ctx, "/openolt.Openolt/GetOnuAllocGemStatistics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *openoltClient) GetPonPortStatistics(ctx context.Context, in *Interface, opts ...grpc.CallOption) (*PonStatsData, error) {
	out := new(PonStatsData)
...
func (c *openoltClient) GetNniPortStatistics(ctx context.Context, in *Onu, opts ...grpc.CallOption) (*NniStatsData, error) {
	out := new(NniStatsData)
...
type OpenoltServer interface {
	...
	// GetOnuAllocGemStatistics takes Onu id, intf_id and serial number as argument from Onu structure.
	// Returns Alloc and Gem stats for the Onu in the form of OnuStatsResponse structure
	GetOnuAllocGemStatistics(context.Context, *Onu) (*OnuStatsResponse, error)
	//
	// GetPonPortStatistics takes interface id and type as argument from Interface structure.
	// Returns Pon port statistics in the form of PonStatsData structure
	GetPonPortStatistics(context.Context, *Interface) (*PonStatsData, error)
	//
	// GetNniPortStatistics takes takes interface id and type as argument from Interface structure.
	// Returns Nni port statistics in the form of NniStatsData structure
	GetNniPortStatistics(context.Context, *Onu) (*NniStatsData, error)
}
...
func (*UnimplementedOpenoltServer) GetOnuAllocGemStatistics(ctx context.Context, req *Onu) (*OnuStatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOnuAllocGemStatistics not implemented")
}
func (*UnimplementedOpenoltServer) GetPonPortStatistics(ctx context.Context, req *Interface) (*PonStatsData, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPonPortStatistics not implemented")
}
func (*UnimplementedOpenoltServer) GetNniPortStatistics(ctx context.Context, req *Onu) (*NniStatsData, error) {
...
func _Openolt_GetOnuAllocGemStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Onu)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OpenoltServer).GetOnuAllocGemStatistics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openolt.Openolt/GetOnuAllocGemStatistics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OpenoltServer).GetOnuAllocGemStatistics(ctx, req.(*Onu))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Openolt_GetNniPortStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OpenoltServer).GetNniPortStatistics(ctx, req.(*Onu))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Openolt_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetOnuAllocGemStatistics",
			Handler:    _Openolt_GetOnuAllocGemStatistics_Handler,
		},
		{
