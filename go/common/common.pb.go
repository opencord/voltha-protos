...
type ValueSpecifier_ValueType int32

const (
	ValueSpecifier_VAL_EMPTY    ValueSpecifier_ValueType = 0
	ValueSpecifier_VAL_DISTANCE ValueSpecifier_ValueType = 1
)

var ValueSpecifier_ValueType_name = map[int32]string{
	0: "VAL_EMPTY",
	1: "VAL_DISTANCE",
}

var ValueSpecifier_ValueType_value = map[string]int32{
	"VAL_EMPTY":    0,
	"VAL_DISTANCE": 1,
}

func (x ValueSpecifier_ValueType) String() string {
	return proto.EnumName(ValueSpecifier_ValueType_name, int32(x))
}

func (ValueSpecifier_ValueType) EnumDescriptor() ([]byte, []int) {
...
type ValueSpecifier struct {
	Value                ValueSpecifier_ValueType `protobuf:"varint,1,opt,name=value,proto3,enum=common.ValueSpecifier_ValueType" json:"value,omitempty"`
	DeviceID             *ID                      `protobuf:"bytes,2,opt,name=deviceID,proto3" json:"deviceID,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
func (m *ValueSpecifier) GetValue() ValueSpecifier_ValueType {
	if m != nil {
		return m.Value
	}
	return ValueSpecifier_VAL_EMPTY
}
...
func init() {
	...
	proto.RegisterEnum("common.ValueSpecifier_ValueType", ValueSpecifier_ValueType_name, ValueSpecifier_ValueType_value)
...
var fileDescriptor_c2e3fd231961e826 = []byte{
	...
	,
}
