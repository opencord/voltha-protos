...
const file_voltha_protos_common_proto_rawDesc = "" +
	...
	"\x15OPERATION_IN_PROGRESS\x10\x03\"\x9b\x13\n" +
	"\x0ePortStatistics\x12\x17\n" +
	"\aintf_id\x18\x01 \x01(\aR\x06intfId\x12\x19\n" +
	"\brx_bytes\x18\x02 \x01(\x06R\arxBytes\x12\x1d\n" +
	"\n" +
	"rx_packets\x18\x03 \x01(\x06R\trxPackets\x12(\n" +
	"\x10rx_ucast_packets\x18\x04 \x01(\x06R\x0erxUcastPackets\x12(\n" +
	"\x10rx_mcast_packets\x18\x05 \x01(\x06R\x0erxMcastPackets\x12(\n" +
	"\x10rx_bcast_packets\x18\x06 \x01(\x06R\x0erxBcastPackets\x12(\n" +
	"\x10rx_error_packets\x18\a \x01(\x06R\x0erxErrorPackets\x12\x1b\n" +
	...
	"\n" +
	"tx_packets\x18\t \x01(\x06R\ttxPackets\x12(\n" +
	"\x10tx_ucast_packets\x18\n" +
	" \x01(\x06R\x0etxUcastPackets\x12(\n" +
	"\x10tx_mcast_packets\x18\v \x01(\x06R\x0etxMcastPackets\x12(\n" +
	"\x10tx_bcast_packets\x18\f \x01(\x06R\x0etxBcastPackets\x12(\n" +
	"\x10tx_error_packets\x18\r \x01(\x06R\x0etxErrorPackets\x12\x1b\n" +
	...
	"\ttimestamp\x18\x10 \x01(\aR\ttimestamp*\x1c\n" +
	"\fTestModeKeys\x12\f\n" +
	"\bapi_test\x10\x00BE\n" +
