...
type VolthaServiceClient interface {
	...
	PutVoipSystemProfile(ctx context.Context, in *voip_technology_profile.VoipSystemProfileRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *volthaServiceClient) PutVoipSystemProfile(ctx context.Context, in *voip_technology_profile.VoipSystemProfileRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type VolthaServiceServer interface {
	...
	// Saves or updates system wide configuration into voltha KV
	PutVoipSystemProfile(context.Context, *voip_technology_profile.VoipSystemProfileRequest) (*empty.Empty, error)
	// Deletes the given profile from voltha KV
...
func (*UnimplementedVolthaServiceServer) PutVoipSystemProfile(ctx context.Context, req *voip_technology_profile.VoipSystemProfileRequest) (*empty.Empty, error) {
...
func _VolthaService_PutVoipSystemProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(voip_technology_profile.VoipSystemProfileRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolthaServiceServer).PutVoipSystemProfile(ctx, req.(*voip_technology_profile.VoipSystemProfileRequest))
	}
	return interceptor(ctx, in, info, handler)
}
