...
const file_voltha_protos_voltha_proto_rawDesc = "" +
	...
	"\x13omci_alarm_database\x18\x1d \x03(\v2\x15.omci.AlarmDeviceDataR\x11omciAlarmDatabaseJ\x04\b\x06\x10\a2\xde:\n" +
	"\rVolthaService\x12D\n" +
	...
	"\x15EnableOnuSerialNumber\x12\x1f.device.OnuSerialNumberOnOLTPon\x1a\x16.google.protobuf.Empty\"(\x82\xd3\xe4\x93\x02\"\" /api/v1/enable_onu_serial_numberBl\n" +
...
var file_voltha_protos_voltha_proto_goTypes = []any{
	...
	(*Adapters)(nil),                                     // 32: adapter.Adapters
	(*LogicalDevices)(nil),                               // 33: logical_device.LogicalDevices
	(*LogicalPorts)(nil),                                 // 34: logical_device.LogicalPorts
	(*LogicalPort)(nil),                                  // 35: logical_device.LogicalPort
	(*openflow_13.Flows)(nil),                            // 36: openflow_13.Flows
	(*openflow_13.Meters)(nil),                           // 37: openflow_13.Meters
	(*openflow_13.FlowGroups)(nil),                       // 38: openflow_13.FlowGroups
	(*Devices)(nil),                                      // 39: device.Devices
	(*common.OperationResp)(nil),                         // 40: common.OperationResp
	(*ImageDownloads)(nil),                               // 41: device.ImageDownloads
	(*DeviceImageResponse)(nil),                          // 42: device.DeviceImageResponse
	(*OnuImages)(nil),                                    // 43: device.OnuImages
	(*Ports)(nil),                                        // 44: device.Ports
	(*DeviceTypes)(nil),                                  // 45: device.DeviceTypes
	(*openflow_13.PacketIn)(nil),                         // 46: openflow_13.PacketIn
	(*openflow_13.ChangeEvent)(nil),                      // 47: openflow_13.ChangeEvent
	(*EventFilters)(nil),                                 // 48: event.EventFilters
	(*Images)(nil),                                       // 49: device.Images
	(*SelfTestResponse)(nil),                             // 50: device.SelfTestResponse
	(*extension.ReturnValues)(nil),                       // 51: extension.ReturnValues
	(*omci.TestResponse)(nil),                            // 52: omci.TestResponse
}
var file_voltha_protos_voltha_proto_depIdxs = []int32{
	...
	2,  // 81: voltha.VolthaService.GetVoltha:output_type -> voltha.Voltha
	1,  // 82: voltha.VolthaService.ListCoreInstances:output_type -> voltha.CoreInstances
	0,  // 83: voltha.VolthaService.GetCoreInstance:output_type -> voltha.CoreInstance
	32, // 84: voltha.VolthaService.ListAdapters:output_type -> adapter.Adapters
	33, // 85: voltha.VolthaService.ListLogicalDevices:output_type -> logical_device.LogicalDevices
	5,  // 86: voltha.VolthaService.GetLogicalDevice:output_type -> logical_device.LogicalDevice
	34, // 87: voltha.VolthaService.ListLogicalDevicePorts:output_type -> logical_device.LogicalPorts
	35, // 88: voltha.VolthaService.GetLogicalDevicePort:output_type -> logical_device.LogicalPort
	11, // 89: voltha.VolthaService.EnableLogicalDevicePort:output_type -> google.protobuf.Empty
	11, // 90: voltha.VolthaService.DisableLogicalDevicePort:output_type -> google.protobuf.Empty
	36, // 91: voltha.VolthaService.ListLogicalDeviceFlows:output_type -> openflow_13.Flows
	11, // 92: voltha.VolthaService.UpdateLogicalDeviceFlowTable:output_type -> google.protobuf.Empty
	11, // 93: voltha.VolthaService.UpdateLogicalDeviceMeterTable:output_type -> google.protobuf.Empty
	37, // 94: voltha.VolthaService.ListLogicalDeviceMeters:output_type -> openflow_13.Meters
	38, // 95: voltha.VolthaService.ListLogicalDeviceFlowGroups:output_type -> openflow_13.FlowGroups
	11, // 96: voltha.VolthaService.UpdateLogicalDeviceFlowGroupTable:output_type -> google.protobuf.Empty
	39, // 97: voltha.VolthaService.ListDevices:output_type -> device.Devices
	17, // 98: voltha.VolthaService.ListDeviceIds:output_type -> common.IDs
	11, // 99: voltha.VolthaService.ReconcileDevices:output_type -> google.protobuf.Empty
	6,  // 100: voltha.VolthaService.GetDevice:output_type -> device.Device
	6,  // 101: voltha.VolthaService.CreateDevice:output_type -> device.Device
	11, // 102: voltha.VolthaService.EnableDevice:output_type -> google.protobuf.Empty
	11, // 103: voltha.VolthaService.DisableDevice:output_type -> google.protobuf.Empty
	11, // 104: voltha.VolthaService.RebootDevice:output_type -> google.protobuf.Empty
	11, // 105: voltha.VolthaService.DeleteDevice:output_type -> google.protobuf.Empty
	11, // 106: voltha.VolthaService.ForceDeleteDevice:output_type -> google.protobuf.Empty
	40, // 107: voltha.VolthaService.DownloadImage:output_type -> common.OperationResp
	18, // 108: voltha.VolthaService.GetImageDownloadStatus:output_type -> device.ImageDownload
	18, // 109: voltha.VolthaService.GetImageDownload:output_type -> device.ImageDownload
	41, // 110: voltha.VolthaService.ListImageDownloads:output_type -> device.ImageDownloads
	40, // 111: voltha.VolthaService.CancelImageDownload:output_type -> common.OperationResp
	40, // 112: voltha.VolthaService.ActivateImageUpdate:output_type -> common.OperationResp
	40, // 113: voltha.VolthaService.RevertImageUpdate:output_type -> common.OperationResp
	42, // 114: voltha.VolthaService.DownloadImageToDevice:output_type -> device.DeviceImageResponse
	42, // 115: voltha.VolthaService.GetImageStatus:output_type -> device.DeviceImageResponse
	42, // 116: voltha.VolthaService.AbortImageUpgradeToDevice:output_type -> device.DeviceImageResponse
	43, // 117: voltha.VolthaService.GetOnuImages:output_type -> device.OnuImages
	42, // 118: voltha.VolthaService.ActivateImage:output_type -> device.DeviceImageResponse
	42, // 119: voltha.VolthaService.CommitImage:output_type -> device.DeviceImageResponse
	44, // 120: voltha.VolthaService.ListDevicePorts:output_type -> device.Ports
	21, // 121: voltha.VolthaService.ListDevicePmConfigs:output_type -> device.PmConfigs
	11, // 122: voltha.VolthaService.UpdateDevicePmConfigs:output_type -> google.protobuf.Empty
	36, // 123: voltha.VolthaService.ListDeviceFlows:output_type -> openflow_13.Flows
	38, // 124: voltha.VolthaService.ListDeviceFlowGroups:output_type -> openflow_13.FlowGroups
	45, // 125: voltha.VolthaService.ListDeviceTypes:output_type -> device.DeviceTypes
	7,  // 126: voltha.VolthaService.GetDeviceType:output_type -> device.DeviceType
	11, // 127: voltha.VolthaService.StreamPacketsOut:output_type -> google.protobuf.Empty
	46, // 128: voltha.VolthaService.ReceivePacketsIn:output_type -> openflow_13.PacketIn
	47, // 129: voltha.VolthaService.ReceiveChangeEvents:output_type -> openflow_13.ChangeEvent
	8,  // 130: voltha.VolthaService.CreateEventFilter:output_type -> event.EventFilter
	48, // 131: voltha.VolthaService.GetEventFilter:output_type -> event.EventFilters
	8,  // 132: voltha.VolthaService.UpdateEventFilter:output_type -> event.EventFilter
	11, // 133: voltha.VolthaService.DeleteEventFilter:output_type -> google.protobuf.Empty
	48, // 134: voltha.VolthaService.ListEventFilters:output_type -> event.EventFilters
	49, // 135: voltha.VolthaService.GetImages:output_type -> device.Images
	50, // 136: voltha.VolthaService.SelfTest:output_type -> device.SelfTestResponse
	9,  // 137: voltha.VolthaService.GetMibDeviceData:output_type -> omci.MibDeviceData
	10, // 138: voltha.VolthaService.GetAlarmDeviceData:output_type -> omci.AlarmDeviceData
	40, // 139: voltha.VolthaService.SimulateAlarm:output_type -> common.OperationResp
	11, // 140: voltha.VolthaService.EnablePort:output_type -> google.protobuf.Empty
	11, // 141: voltha.VolthaService.DisablePort:output_type -> google.protobuf.Empty
	51, // 142: voltha.VolthaService.GetExtValue:output_type -> extension.ReturnValues
	11, // 143: voltha.VolthaService.SetExtValue:output_type -> google.protobuf.Empty
	52, // 144: voltha.VolthaService.StartOmciTestAction:output_type -> omci.TestResponse
	11, // 145: voltha.VolthaService.PutVoipSystemProfile:output_type -> google.protobuf.Empty
	11, // 146: voltha.VolthaService.DeleteVoipSystemProfile:output_type -> google.protobuf.Empty
	11, // 147: voltha.VolthaService.PutVoipUserProfile:output_type -> google.protobuf.Empty
	11, // 148: voltha.VolthaService.DeleteVoipUserProfile:output_type -> google.protobuf.Empty
	11, // 149: voltha.VolthaService.DisableOnuDevice:output_type -> google.protobuf.Empty
	11, // 150: voltha.VolthaService.EnableOnuDevice:output_type -> google.protobuf.Empty
	11, // 151: voltha.VolthaService.DisableOnuSerialNumber:output_type -> google.protobuf.Empty
	11, // 152: voltha.VolthaService.EnableOnuSerialNumber:output_type -> google.protobuf.Empty
	81, // [81:153] is the sub-list for method output_type
	9,  // [9:81] is the sub-list for method input_type
