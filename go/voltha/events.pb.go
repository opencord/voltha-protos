...
type AlarmEvent struct {
	...
	ResourceId string `protobuf:"bytes,9,opt,name=resource_id" json:"resource_id,omitempty"`
	...
	// logical device id
	LogicalDeviceId string `protobuf:"bytes,12,opt,name=logical_device_id" json:"logical_device_id,omitempty"`
	// alarm_type  name indicates clearly the name of the alarm
	AlarmTypeName string `protobuf:"bytes,13,opt,name=alarm_type_name" json:"alarm_type_name,omitempty"`
}
