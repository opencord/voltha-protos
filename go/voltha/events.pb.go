...
const (
	EventType_COMMUNICATION EventType_EventType = 0
	EventType_ENVIRONMENT   EventType_EventType = 1
	EventType_EQUIPMENT     EventType_EventType = 2
	EventType_SERVICE       EventType_EventType = 3
	EventType_PROCESSING    EventType_EventType = 4
	EventType_SECURITY      EventType_EventType = 5
)
...
const (
	EventState_RAISED  EventState_EventState = 0
	EventState_CLEARED EventState_EventState = 1
	EventState_UNKNOWN EventState_EventState = 2
)
...
type EventHeader struct {
	...
	// Refers to the area of the system impacted by the event
	Type EventType_EventType `protobuf:"varint,2,opt,name=type,enum=voltha.EventType_EventType" json:"type,omitempty"`
	...
	RaisedTs float32 `protobuf:"fixed32,5,opt,name=raised_ts" json:"raised_ts,omitempty"`
	// Timestamp at which the event was reported
	ReportedTs float32 `protobuf:"fixed32,6,opt,name=reported_ts" json:"reported_ts,omitempty"`
	// Timestamp at which the event has changed since it was raised
	ChangedTs float32 `protobuf:"fixed32,7,opt,name=changed_ts" json:"changed_ts,omitempty"`
}
...
//
// Identify the body of events specific to device
type DeviceEventBody struct {
...
func (m *DeviceEventBody) Reset()         { *m = DeviceEventBody{} }
func (m *DeviceEventBody) String() string { return proto.CompactTextString(m) }
func (*DeviceEventBody) ProtoMessage()    {}

func (m *DeviceEventBody) GetContext() map[string]string {
	if m != nil {
		return m.Context
	}
	return nil
...
type Event struct {
	...
	Device *DeviceEventBody `protobuf:"bytes,2,opt,name=device" json:"device,omitempty"`
}
...
func (m *Event) GetDevice() *DeviceEventBody {
	if m != nil {
		return m.Device
	}
	return nil
