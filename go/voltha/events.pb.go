...
const (
	...
	EventFilterRuleKey_onu_event_type    EventFilterRuleKey_EventFilterRuleType = 6
)
...
const (
	...
	EventType_ONU_EVENT    EventType_Types = 5
)
...
type Event_OnuEvent struct {
	OnuEvent *OnuEvent `protobuf:"bytes,7,opt,name=onu_event,json=onuEvent,proto3,oneof"`
}
...
func (*Event_OnuEvent) isEvent_EventType() {}
...
func (m *Event) GetOnuEvent() *OnuEvent {
	if x, ok := m.GetEventType().(*Event_OnuEvent); ok {
		return x.OnuEvent
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*OnuEvent)(nil), "event.OnuEvent")
...
var fileDescriptor_e63e6c07044fd2c4 = []byte{
	...
	,
}
