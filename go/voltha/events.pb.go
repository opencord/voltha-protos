...
func (EventCategory_Types) EnumDescriptor() ([]byte, []int) {
	return file_voltha_protos_events_proto_rawDescGZIP(), []int{14, 0}
}
...
func (EventSubCategory_Types) EnumDescriptor() ([]byte, []int) {
	return file_voltha_protos_events_proto_rawDescGZIP(), []int{15, 0}
}
...
const file_voltha_protos_events_proto_rawDesc = "" +
	...
	"\fMetricsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x02R\x05value:\x028\x01\"\xda\x01\n" +
	"\bKpiEvent\x12-\n" +
	...
	"\n" +
	"slice_data\x18\x03 \x03(\v2\x18.event.MetricInformationR\tsliceData\"\xf3\x01\n" +
	...
	"\trpc_event\x18\x06 \x01(\v2\x0f.event.RPCEventH\x00R\brpcEventB\f\n" +
	"\n" +
	"event_typeBL\n" +
...
var file_voltha_protos_events_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_voltha_protos_events_proto_goTypes = []any{
	...
	(*KpiEvent)(nil),                            // 16: event.KpiEvent
	(*KpiEvent2)(nil),                           // 17: event.KpiEvent2
	(*DeviceEvent)(nil),                         // 18: event.DeviceEvent
	(*RPCEvent)(nil),                            // 19: event.RPCEvent
	(*EventCategory)(nil),                       // 20: event.EventCategory
	(*EventSubCategory)(nil),                    // 21: event.EventSubCategory
	(*EventType)(nil),                           // 22: event.EventType
	(*EventHeader)(nil),                         // 23: event.EventHeader
	(*Event)(nil),                               // 24: event.Event
	nil,                                         // 25: event.MetricMetaData.ContextEntry
	nil,                                         // 26: event.MetricValuePairs.MetricsEntry
	nil,                                         // 27: event.MetricInformation.MetricsEntry
	nil,                                         // 28: event.KpiEvent.PrefixesEntry
	nil,                                         // 29: event.DeviceEvent.ContextEntry
	nil,                                         // 30: event.RPCEvent.ContextEntry
	(*common.OperationResp)(nil),                // 31: common.OperationResp
...
var file_voltha_protos_events_proto_depIdxs = []int32{
	...
	25, // 4: event.MetricMetaData.context:type_name -> event.MetricMetaData.ContextEntry
	26, // 5: event.MetricValuePairs.metrics:type_name -> event.MetricValuePairs.MetricsEntry
	13, // 6: event.MetricInformation.metadata:type_name -> event.MetricMetaData
	27, // 7: event.MetricInformation.metrics:type_name -> event.MetricInformation.MetricsEntry
	2,  // 8: event.KpiEvent.type:type_name -> event.KpiEventType.Types
	28, // 9: event.KpiEvent.prefixes:type_name -> event.KpiEvent.PrefixesEntry
	2,  // 10: event.KpiEvent2.type:type_name -> event.KpiEventType.Types
	15, // 11: event.KpiEvent2.slice_data:type_name -> event.MetricInformation
	29, // 12: event.DeviceEvent.context:type_name -> event.DeviceEvent.ContextEntry
	30, // 13: event.RPCEvent.context:type_name -> event.RPCEvent.ContextEntry
	31, // 14: event.RPCEvent.status:type_name -> common.OperationResp
	3,  // 15: event.EventHeader.category:type_name -> event.EventCategory.Types
	4,  // 16: event.EventHeader.sub_category:type_name -> event.EventSubCategory.Types
	5,  // 17: event.EventHeader.type:type_name -> event.EventType.Types
	32, // 18: event.EventHeader.raised_ts:type_name -> google.protobuf.Timestamp
	32, // 19: event.EventHeader.reported_ts:type_name -> google.protobuf.Timestamp
	23, // 20: event.Event.header:type_name -> event.EventHeader
	11, // 21: event.Event.config_event:type_name -> event.ConfigEvent
	16, // 22: event.Event.kpi_event:type_name -> event.KpiEvent
	17, // 23: event.Event.kpi_event2:type_name -> event.KpiEvent2
	18, // 24: event.Event.device_event:type_name -> event.DeviceEvent
	19, // 25: event.Event.rpc_event:type_name -> event.RPCEvent
	14, // 26: event.KpiEvent.PrefixesEntry.value:type_name -> event.MetricValuePairs
...
func file_voltha_protos_events_proto_init() {
	...
	file_voltha_protos_events_proto_msgTypes[18].OneofWrappers = []any{
