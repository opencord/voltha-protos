...
PROTOC_SH = docker run --rm --user $$(id -u):$$(id -g) -v ${CURDIR}:/go/src/github.com/opencord/voltha-protos/v3 --workdir=/go/src/github.com/opencord/voltha-protos/v3 khagerma/voltha-tools:${VOLTHA_TOOLS_VERSION}-protoc sh -c
