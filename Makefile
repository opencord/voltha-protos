...
golang : go-clean     go-protos    go-test
python : python-clean python-protos python-build python-test
java   : java-clean   java-protos   java-test
...
java-test: java-protos
	...
	MAVEN_OPTS='-Xlint:deprecation' cp test/pom.xml java_temp
